 ...
 **/
 ...
 (function() {
    ...
    function initHeader() {
        ...
        for(var i in points) {
        	var c = new Circle(points[i], 2+Math.random()*1.2, 'rgba(255,255,255,0.3)');
        	points[i].circle = c;
        }
    }
    	...
    	if(animateHeader) {
    		...
    		for(var i in points) {
                ...
                if(Math.abs(getDistance(target, points[i])) < 5000) {
                	...
                	points[i].active = 0.175;
                	points[i].circle.active = 0.325;
                } else if(Math.abs(getDistance(target, points[i])) < 40000) {
                	points[i].active = 0.04;
                	points[i].circle.active = 0.225;
                } else {
                	points[i].active = 0;
    ...
    function shiftPoint(p) {
    	TweenLite.to(p, 1+1*Math.random(), {x:p.originX-50+Math.random(),
    		y: p.originY-50+Math.random(), ease:Circ.easeInOut,
    		onComplete: function() {
    			shiftPoint(p);
    		}});
    }
